...
export const Footer = () => {
  return (
    <main className=" bg-green-600">
      <div
        className=" md:grid md:grid-cols-3 h-[25vh] md:h-[33vh]
     justify-center flex "
      >
        {/* === Quick Links  */}
        <div
          className=" hidden mt-5  px-3
     pl-[30%] flex-col items-center text-white font-bold md:block "
        >
          <h1
            className=" inline border-white border-t-4
    text-2xl font-extrabold font-sans mb-2"
          >
            {" "}
            Quick Links{" "}
          </h1>
          ...
          <ul>
            ...
            <Link href="/northamerica">
              <a className=" block hover:underline cursor-pointer">
                {" "}
                North America{" "}
              </a>
            </Link>
        ...
        <div className="flex flex-col items-center">
          <Link href="/">
            <a
              className=" text-center px-2  shadow-sm rounded-sm
    ...
    text-white font-semibold "
        ...
        {/* // Contact Details */}
        <div
          className=" pl-[30%] hidden mt-5
    flex-col text-white font-bold md:block "
        >
          <h1
            className=" text-2xl font-extrabold font-sans mb-2
    inline border-white border-t-4"
          >
            {" "}
            Contact{" "}
          </h1>
          ...
          <div className="flex items-center">
            ...
            >
              ...
              <path
                d="M5 4h4l2 5l-2.5 1.5a11 11 0 0 0 5 5l1.5 -2.5l5 2v4a2
    2 0 0 1 -2 2a16 16 0 0 1 -15 -15a2 2 0 0 1 2 -2"
      ...
      <p className="  text-white text-center">News-Stand © 2022</p>
    </main>
  );
};
